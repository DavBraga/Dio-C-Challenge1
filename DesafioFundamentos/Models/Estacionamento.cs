    ...
    public class Estacionamento
    {
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                do
                {
                    Console.WriteLine("Digite uma quantidade válida de horas que o veículo permaneceu estacionado:");

                } while( !Int32.TryParse(Console.ReadLine(), out  horas));
        ...
        public void ListarVeiculos()
        {
            ...
            if (veiculos.Any())
            {
                ...
                {
                    Console.WriteLine($"O veículo de placa {vehicle}.");
                }
